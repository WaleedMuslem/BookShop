    ...
    if (is_post()) {
        ...
        if (!count($errors)) {
            ...
            if (!count($errors)) {
                ...
                $stmt = $db->prepare("INSERT INTO books (user_id, title, author, year, description, cover) VALUES (:user_id, :title, :author, :year, :description, :cover)");
                ...
                try {
                    ...
                    redirect('book', ['id' => $new_id, 'success' => 1]);
